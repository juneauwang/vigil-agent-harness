...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Vigil session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Vigil session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Vigil agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Vigil Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Vigil gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Vigil session in it",
