...
class RelayAdapter(BasePlatformAdapter):
        ...
        try:
            ...
            if platform == "discord":
                ...
                if event is not None:
                    self._capture_scope(event)
                    # Phase 3: a component press carrying a Vigil prompt token
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        if itype == 3:
            # Phase 3: a component press whose custom_id is a Vigil prompt
    ...
    def _decode_prompt_token(token: str):
        ...
        — and is not — a Vigil prompt answer.
        """
        import re
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack Vigil already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # Vigil suppresses this synthetic DM thread anchor; drop it here for the
