...
All per-subject data lives under PDD_DATA_DIR (default: $VIGIL_HOME/unbroker),
which is the same trust boundary Vigil uses for .env and OAuth tokens.
"""
...
def hermes_home() -> Path:
    return Path(os.environ.get("VIGIL_HOME") or (Path.home() / ".vigil"))
