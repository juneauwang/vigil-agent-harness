...
Data file: $VIGIL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_VIGIL_HOME = Path(os.environ.get("VIGIL_HOME", Path.home() / ".vigil"))
DATA_DIR = _VIGIL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
