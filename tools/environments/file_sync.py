...
_FORCE_SYNC_ENV = "VIGIL_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.vigil") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.vigil to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``VIGIL_FORCE_FILE_SYNC=1`` is set.
    ...
    def _sync_back_transaction(self, hermes_home: Path | None = None) -> None:
        ...
        # against an uninitialized remote .vigil/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.vigil/skills/a.md`` →
        ``~/.vigil/skills/a.md``, a new remote file at
        ``/root/.vigil/skills/b.md`` maps to ``~/.vigil/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
