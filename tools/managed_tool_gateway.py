...
def auth_json_path():
    """Return the Vigil auth store path, respecting VIGIL_HOME overrides."""
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`vigil tools`, banner/status paint, provider
...
# managed vendor's gateway URL is pinned: adding one is a Vigil release, and
