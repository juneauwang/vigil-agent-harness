...
2. User-installed providers: ``$VIGIL_HOME/plugins/<name>/``
...
def _get_user_plugins_dir() -> Optional[Path]:
    """Return ``$VIGIL_HOME/plugins/`` or None if unavailable."""
    try:
...
def load_cron_scheduler(name: str) -> Optional["CronScheduler"]:  # noqa: F821
    ...
    (``$VIGIL_HOME/plugins/<name>/``) directories. Bundled takes precedence
    on name collisions.
