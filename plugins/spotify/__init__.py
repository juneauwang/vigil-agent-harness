...
``_check_spotify_available()`` — when the user has not run ``vigil auth
spotify``, the tools remain registered (so they appear in ``vigil
...
The Spotify auth flow (``vigil auth spotify``), CLI plumbing, and docs
