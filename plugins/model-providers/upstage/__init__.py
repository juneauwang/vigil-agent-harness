...
# When the user hasn't picked a reasoning effort, Vigil passes
...
# ON at this effort — matching the "medium (default)" that Vigil' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Vigil' effort vocabulary onto Solar's accepted set. xhigh/max/
