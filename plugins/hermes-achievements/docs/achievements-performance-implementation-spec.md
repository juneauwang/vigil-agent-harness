# Vigil Achievements Implementation Spec (Detailed)
...
Storage path:
- `~/.vigil/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.vigil/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.vigil/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.vigil/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.vigil/plugins/hermes-achievements/scan_checkpoint.json` (new)
