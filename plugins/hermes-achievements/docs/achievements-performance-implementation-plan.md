# Vigil Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.vigil/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.vigil/plugins/hermes-achievements/scan_checkpoint.json`.
