"""
Email platform adapter for the Vigil gateway.

Allows users to interact with Vigil by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # send-helper, and `vigil config show` already read. Without the
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Vigil Agent")
