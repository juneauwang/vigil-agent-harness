...
Config: ~/.vigil/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.vigil/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (VIGIL_HOME-aware and
