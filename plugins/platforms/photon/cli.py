...
# Writable sidecar runtime dir (mirrors to VIGIL_HOME on immutable
...
# wiring imports this module for `vigil --help`).
...
# when called later (gateway start, vigil status). Cleared on success.
...
def _cmd_setup(args: argparse.Namespace) -> int:
    ...
    # 3. Provision Spectrum credentials (runtime -> ~/.vigil/.env,
