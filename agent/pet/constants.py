...
row taxonomy is inferred from the atlas shape so Vigil can render both legacy
...
# rows (1536x1872), while older Vigil/petdex sheets used 9 columns x 8 rows
...
class PetState(str, Enum):
    ...
    These are Vigil' activity state names. They are not always identical to the
...
# Canonical Vigil activity names -> accepted row-name aliases in descending
