...
Plugins built on Vigil Agent often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing Vigil
...
embedded slugs, no shorthands. This mirrors Vigil' main config
...
handles every provider, fallback chain, and per-task override Vigil
supports.
"""
