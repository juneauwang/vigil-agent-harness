"""Core NeMo Relay adapter for Vigil tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Vigil tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Vigil Relay tool execution cannot run on an active event-loop thread"
    )
