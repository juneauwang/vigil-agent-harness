"""Client for uploading ``vigil debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``vigil debug share``.
...
NAS_BASE = os.environ.get(
    "VIGIL_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
