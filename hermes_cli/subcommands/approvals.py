...
def build_approvals_parser(subparsers, *, cmd_approvals: Callable) -> None:
    ...
    forget_parser = approvals_subparsers.add_parser(
        "forget",
        help="撤销单条自进化白名单条目（删除后该命令回到弹审批状态）",
        description=(
