...
Used by ``vigil profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Vigil Agent kanban board.
...
Rules:
  ...
  - Never write "Vigil Agent profile" or other meta-narration.
