...
Entry point: ``vigil whatsapp-cloud`` (dispatched from
...
Vigil gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Vigil to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Vigil needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Vigil gateway in another terminal:")
    print("         vigil gateway")
    print()
