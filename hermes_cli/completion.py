"""Shell completion script generation for vigil CLI.
...
complete -F _hermes_completion hermes vigil
"""
...
{top_cmds_str}
            ...
            _describe 'vigil command' subcmds
            ;;
        args)
            case ${{line[1]}} in
{sub_cases_str}
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        "# Complete profile names after -p / --profile",
        "complete -c vigil -f -s p -l profile"
