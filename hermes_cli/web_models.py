"""Pydantic request/response models for the Vigil dashboard web server.
...
class ModelAssignment(BaseModel):
    ...
    # ``vigil model`` custom flow collects.
    api_key: str = ""
...
class ImportRequest(BaseModel):
    archive: str
    # Pass --force to `vigil import`. The spawned action runs with
...
class ProfileExport(BaseModel):
    ...
    # Where to write the archive. Empty → a staging path under VIGIL_HOME.
    output: str = ""
