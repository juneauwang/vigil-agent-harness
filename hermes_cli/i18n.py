...
_EN: dict[str, str] = {
    ...
    "runbook_exec.script_remote_scp_failed": "Script asset {name!r} upload to {host} failed: {exc}",
    "runbook_exec.script_remote_scp_timeout": "Script asset {name!r} upload to {host} timed out ({timeout}s)",
    "runbook_exec.script_remote_timeout": "Script asset {name!r} remote execution timed out ({timeout}s)",
    "runbook_exec.script_remote_exec_failed": "Script asset {name!r} remote execution failed: {exc}",
