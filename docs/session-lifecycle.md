...
Counts consecutive restarts via a JSON file (`{VIGIL_HOME}/restart_counts.json`). If a
...
This prevents unwanted auto-resets after `vigil update`, `vigil gateway restart`,
or `/restart`.
