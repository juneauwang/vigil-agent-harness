#!/usr/bin/env python3
"""Google Workspace API CLI for Vigil Agent.
...
def _gws_binary() -> str | None:
    override = os.getenv("VIGIL_GWS_BIN")
    if override:
        return override
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Vigil Agent")
