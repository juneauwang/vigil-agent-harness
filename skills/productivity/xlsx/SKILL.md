...
For full investment-banking conventions (balance checks, sensitivity tables, named ranges), install the optional skill: `vigil skills install official/finance/excel-author`.
