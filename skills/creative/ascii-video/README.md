...
Built for [Vigil](https://github.com/juneauwang/vigil-agent-harness). Usable in any coding agent. Canonical source lives here; synced to [`juneauwang/vigil-agent-harness/skills/creative/ascii-video`](https://github.com/juneauwang/vigil-agent-harness) via PR.
