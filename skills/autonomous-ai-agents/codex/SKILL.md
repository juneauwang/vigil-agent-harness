...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Vigil terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Vigil itself, `model.provider: openai-codex` uses Hermes-managed Codex
...
## Vigil Gateway Caveat

When invoking the Codex CLI from a Vigil gateway/service context (for example,
