#!/usr/bin/env python3
"""Build the Vigil Skills Index — a centralized JSON catalog of all skills.
...
`vigil skills search/install` can use it without hitting the GitHub API.
...
# Ensure VIGIL_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Vigil Skills Index...", flush=True)
