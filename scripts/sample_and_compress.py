...
DEFAULT_DATASETS = [
    ...
    "juneauwang/vigil-agent-harness-megascience-sft1",
    "juneauwang/vigil-agent-harness-Thinking-GLM-4.7-SFT2",
    "juneauwang/vigil-agent-harness-Thinking-GLM-4.7-SFT1",
