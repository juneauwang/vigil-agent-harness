#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Vigil logs.
...
With no LOGFILE, reads ``$VIGIL_HOME/logs/agent.log`` (default ~/.vigil).
...
def default_log() -> Path:
    home = os.environ.get("VIGIL_HOME") or str(Path.home() / ".vigil")
