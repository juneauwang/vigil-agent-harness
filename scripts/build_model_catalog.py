#!/usr/bin/env python3
"""Build the Vigil Model Catalog — a centralized JSON manifest of curated models.
...
Vigil CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Vigil release.
...
# Ensure VIGIL_HOME is set for imports that touch it at module level.
os.environ.setdefault("VIGIL_HOME", os.path.join(os.path.expanduser("~"), ".vigil"))
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Vigil '
