#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Vigil docs site.
...
SITE_BASE = "https://github.com/juneauwang/vigil-agent-harness"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Vigil"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/juneauwang/vigil-agent-harness")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Vigil Agent — Full Documentation\n",
        (
            "This file is the entire Vigil Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Vigil, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://github.com/juneauwang/vigil-agent-harness",
        "Short index: https://github.com/juneauwang/vigil-agent-harness",
        "\n---\n\n",
    ]
