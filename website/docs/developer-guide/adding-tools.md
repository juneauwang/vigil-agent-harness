...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Vigil — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Vigil tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Vigil core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Vigil Plugin](/developer-guide/plugins)
...
2. **`toolsets.py`** — add tool name to `_VIGIL_CORE_TOOLS` (or a specific toolset)
...
- [ ] Tested with `vigil chat -q "Use the weather tool for London"`
