...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Vigil — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Vigil! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Vigil core? Start with [Build a Vigil Plugin](../developer-guide/plugins/index.md)
...
You can also run a fully isolated Vigil instance (throwaway VIGIL_HOME, separate Electron
...
- **Profile-safe paths**: Never hardcode `~/.vigil` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/juneauwang/vigil-agent-harness) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/juneauwang/vigil-agent-harness).
