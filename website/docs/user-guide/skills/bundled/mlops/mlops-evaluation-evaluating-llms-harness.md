...
**Benchmark descriptions**: See [references/benchmark-guide.md](https://github.com/juneauwang/vigil-agent-harness) for detailed description of all 60+ tasks, what they measure, and interpretation.

**Custom tasks**: See [references/custom-tasks.md](https://github.com/juneauwang/vigil-agent-harness) for creating domain-specific evaluation tasks.

**API evaluation**: See [references/api-evaluation.md](https://github.com/juneauwang/vigil-agent-harness) for evaluating OpenAI, Anthropic, and other API models.

**Multi-GPU strategies**: See [references/distributed-eval.md](https://github.com/juneauwang/vigil-agent-harness) for data parallel and tensor parallel evaluation.
