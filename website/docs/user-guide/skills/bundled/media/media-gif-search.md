...
Set your Tenor API key in your environment (add to `${VIGIL_HOME:-~/.vigil}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/juneauwang/vigil-agent-harness)`
