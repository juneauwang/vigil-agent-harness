...
> Script paths below are relative to this skill's directory. Form filling has its own workflow — read [forms.md](https://github.com/juneauwang/vigil-agent-harness) and follow it. Advanced library usage (pypdfium2, pdf-lib) and troubleshooting: [reference.md](https://github.com/juneauwang/vigil-agent-harness).
...
| Fill PDF forms | see [forms.md](https://github.com/juneauwang/vigil-agent-harness) | `scripts/fill_fillable_fields.py` etc. |
...
Read [forms.md](https://github.com/juneauwang/vigil-agent-harness) first — it distinguishes fillable (AcroForm) PDFs from flat scanned forms and walks through the helper scripts:
