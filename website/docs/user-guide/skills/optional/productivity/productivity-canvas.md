...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Vigil"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${VIGIL_HOME:-~/.vigil}/.env`:
