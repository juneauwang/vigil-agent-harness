...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/juneauwang/vigil-agent-harness)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/juneauwang/vigil-agent-harness)** - Common issues, debugging, performance tuning
