...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/pytorch-lightning` |
...
**Callbacks**: See [references/callbacks.md](https://github.com/juneauwang/vigil-agent-harness) for EarlyStopping, ModelCheckpoint, custom callbacks, and callback hooks.

**Distributed strategies**: See [references/distributed.md](https://github.com/juneauwang/vigil-agent-harness) for DDP, FSDP, DeepSpeed ZeRO integration, multi-node setup.

**Hyperparameter tuning**: See [references/hyperparameter-tuning.md](https://github.com/juneauwang/vigil-agent-harness) for integration with Optuna, Ray Tune, and WandB sweeps.
