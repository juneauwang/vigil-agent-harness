...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/simpo` |
...
**Loss functions**: See [references/loss-functions.md](https://github.com/juneauwang/vigil-agent-harness) for sigmoid vs hinge loss, mathematical formulations, and when to use each.

**Hyperparameter tuning**: See [references/hyperparameters.md](https://github.com/juneauwang/vigil-agent-harness) for beta, gamma, learning rate selection guide, and model-size-specific recommendations.

**Dataset preparation**: See [references/datasets.md](https://github.com/juneauwang/vigil-agent-harness) for preference data formats, quality filtering, and custom dataset creation.
