...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/juneauwang/vigil-agent-harness)** - Multi-GPU, distributed training, cost optimization
