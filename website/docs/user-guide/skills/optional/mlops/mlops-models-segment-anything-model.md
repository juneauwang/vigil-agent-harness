...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/segment-anything-model` |
...
- **[Advanced Usage](https://github.com/juneauwang/vigil-agent-harness)** - Batching, fine-tuning, integration
