...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/saelens` |
...
| File | Contents |
|------|----------|
| [references/README.md](https://github.com/juneauwang/vigil-agent-harness) | Overview and quick start guide |
| [references/api.md](https://github.com/juneauwang/vigil-agent-harness) | Complete API reference for SAE, TrainingSAE, configurations |
| [references/tutorials.md](https://github.com/juneauwang/vigil-agent-harness) | Step-by-step tutorials for training, analysis, steering |
