...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/lambda-labs` |
...
- **[Advanced Usage](https://github.com/juneauwang/vigil-agent-harness)** - Multi-node training, API automation
