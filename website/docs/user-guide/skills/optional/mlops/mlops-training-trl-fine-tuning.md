...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/trl-fine-tuning` |
...
For in-depth GRPO guidance — reward function design, critical training insights (loss behavior, mode collapse, tuning), and advanced multi-stage patterns — see **[references/grpo-training.md](https://github.com/juneauwang/vigil-agent-harness)**. A production-ready training script is in **[templates/basic_grpo_training.py](https://github.com/juneauwang/vigil-agent-harness)**.
...
**SFT training guide**: See [references/sft-training.md](https://github.com/juneauwang/vigil-agent-harness) for dataset formats, chat templates, packing strategies, and multi-GPU training.

**DPO variants**: See [references/dpo-variants.md](https://github.com/juneauwang/vigil-agent-harness) for IPO, cDPO, RPO, and other DPO loss functions with recommended hyperparameters.

**Reward modeling**: See [references/reward-modeling.md](https://github.com/juneauwang/vigil-agent-harness) for outcome vs process rewards, Bradley-Terry loss, and reward model evaluation.

**Online RL methods**: See [references/online-rl.md](https://github.com/juneauwang/vigil-agent-harness) for PPO, GRPO, RLOO, and OnlineDPO with detailed configurations.

**GRPO deep dive**: See [references/grpo-training.md](https://github.com/juneauwang/vigil-agent-harness) for expert-level GRPO patterns — reward function design philosophy, training insights (why loss increases, mode collapse detection), hyperparameter tuning, multi-stage training, and troubleshooting. Production-ready template in [templates/basic_grpo_training.py](https://github.com/juneauwang/vigil-agent-harness).
