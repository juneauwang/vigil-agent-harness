...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/juneauwang/vigil-agent-harness)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/juneauwang/vigil-agent-harness)** - Common errors, debugging, optimization
