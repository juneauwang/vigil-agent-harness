...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/accelerate` |
...
**Megatron integration**: See [references/megatron-integration.md](https://github.com/juneauwang/vigil-agent-harness) for tensor parallelism, pipeline parallelism, and sequence parallelism setup.

**Custom plugins**: See [references/custom-plugins.md](https://github.com/juneauwang/vigil-agent-harness) for creating custom distributed plugins and advanced configuration.

**Performance tuning**: See [references/performance.md](https://github.com/juneauwang/vigil-agent-harness) for profiling, memory optimization, and best practices.
