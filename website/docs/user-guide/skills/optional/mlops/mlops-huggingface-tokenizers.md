...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/huggingface-tokenizers` |
...
- **[Training Guide](https://github.com/juneauwang/vigil-agent-harness)** - Train custom tokenizers, configure trainers, handle large datasets
- **[Algorithms Deep Dive](https://github.com/juneauwang/vigil-agent-harness)** - BPE, WordPiece, Unigram explained in detail
- **[Pipeline Components](https://github.com/juneauwang/vigil-agent-harness)** - Normalizers, pre-tokenizers, post-processors, decoders
- **[Transformers Integration](https://github.com/juneauwang/vigil-agent-harness)** - AutoTokenizer, PreTrainedTokenizerFast, special tokens
