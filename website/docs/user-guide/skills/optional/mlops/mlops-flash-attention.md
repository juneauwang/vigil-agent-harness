...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/flash-attention` |
...
**Integration with HuggingFace Transformers**: See [references/transformers-integration.md](https://github.com/juneauwang/vigil-agent-harness) for enabling Flash Attention in BERT, GPT, Llama models.

**Performance benchmarks**: See [references/benchmarks.md](https://github.com/juneauwang/vigil-agent-harness) for detailed speed and memory comparisons across GPUs and sequence lengths.
