...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/stable-diffusion` |
...
- **[Advanced Usage](https://github.com/juneauwang/vigil-agent-harness)** - Custom pipelines, fine-tuning, deployment
