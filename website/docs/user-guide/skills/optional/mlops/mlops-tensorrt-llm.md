...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/tensorrt-llm` |
...
- **[Optimization Guide](https://github.com/juneauwang/vigil-agent-harness)** - Quantization, batching, KV cache tuning
- **[Multi-GPU Setup](https://github.com/juneauwang/vigil-agent-harness)** - Tensor/pipeline parallelism, multi-node
- **[Serving Guide](https://github.com/juneauwang/vigil-agent-harness)** - Production deployment, monitoring, autoscaling
