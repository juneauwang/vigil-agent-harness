...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/torchtitan` |
...
**FSDP2 configuration**: See [references/fsdp.md](https://github.com/juneauwang/vigil-agent-harness) for detailed FSDP2 vs FSDP1 comparison and ZeRO equivalents.

**Float8 training**: See [references/float8.md](https://github.com/juneauwang/vigil-agent-harness) for tensorwise vs rowwise scaling recipes.

**Checkpointing**: See [references/checkpoint.md](https://github.com/juneauwang/vigil-agent-harness) for HuggingFace conversion and async checkpointing.

**Adding custom models**: See [references/custom-models.md](https://github.com/juneauwang/vigil-agent-harness) for TrainSpec protocol.
