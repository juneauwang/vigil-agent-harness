...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/mlops/nemo-curator` |
...
- **[Filtering Guide](https://github.com/juneauwang/vigil-agent-harness)** - 30+ quality filters, heuristics
- **[Deduplication Guide](https://github.com/juneauwang/vigil-agent-harness)** - Exact, fuzzy, semantic methods
