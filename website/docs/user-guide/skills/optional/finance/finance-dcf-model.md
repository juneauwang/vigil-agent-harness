...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/finance/dcf-model` |
...
**If you encounter errors or unreasonable results, read [TROUBLESHOOTING.md](https://github.com/juneauwang/vigil-agent-harness) for detailed debugging guidance.**
...
3. **Check output**:
   ...
   - If `status` is `"errors_found"` → Check `error_summary` and read [TROUBLESHOOTING.md](https://github.com/juneauwang/vigil-agent-harness) for debugging guidance
