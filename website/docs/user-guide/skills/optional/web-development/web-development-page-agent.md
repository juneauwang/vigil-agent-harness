...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/web-development/page-agent` |
...
- User wants **Vigil itself to drive a browser** → use Vigil' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
