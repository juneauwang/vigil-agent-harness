...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/security/oss-forensics` |
...
> resolve `SKILL_DIR` to the actual path — e.g. `~/.vigil/skills/security/oss-forensics/`
...
**Reference**: See [evidence-types.md](https://github.com/juneauwang/vigil-agent-harness) for IOC taxonomy.
...
**Reference**: See [recovery-techniques.md](https://github.com/juneauwang/vigil-agent-harness) for accessing force-pushed commits.
...
**Reference**: See [evidence-types.md](https://github.com/juneauwang/vigil-agent-harness) for GH event types.
...
**Reference**: See [github-archive-guide.md](https://github.com/juneauwang/vigil-agent-harness) for CDX API parameters.
...
**Reference**: See [github-archive-guide.md](https://github.com/juneauwang/vigil-agent-harness) for all 12 event types and query patterns.
...
- Recover force-pushed commits using 3 methods (see [recovery-techniques.md](https://github.com/juneauwang/vigil-agent-harness))
...
**Common hypothesis templates** (see [investigation-templates.md](https://github.com/juneauwang/vigil-agent-harness)):
...
Populate `investigation-report.md` using the template in [forensic-report.md](https://github.com/juneauwang/vigil-agent-harness).
...
- [github-archive-guide.md](https://github.com/juneauwang/vigil-agent-harness) — BigQuery queries, CDX API, 12 event types
- [evidence-types.md](https://github.com/juneauwang/vigil-agent-harness) — IOC taxonomy, evidence source types, observation types
- [recovery-techniques.md](https://github.com/juneauwang/vigil-agent-harness) — Recovering deleted commits, PRs, issues
- [investigation-templates.md](https://github.com/juneauwang/vigil-agent-harness) — Pre-built hypothesis templates per attack type
- [evidence-store.py](https://github.com/juneauwang/vigil-agent-harness) — CLI tool for managing the evidence JSON store
- [forensic-report.md](https://github.com/juneauwang/vigil-agent-harness) — Structured report template
