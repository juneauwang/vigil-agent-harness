...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/research/qmd` |
...
Vigil via the native MCP client. This is the preferred
...
Then configure Vigil to connect via HTTP:
