...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Vigil |
| License | MIT |
...
import upstream classes into Vigil itself.
...
Open `~/.vigil/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Vigil core.
   Custom driver scripts under `~/.vigil/skills/...` are user-side and fine.
