...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/research/bioinformatics` |
...
- The fetched skills are NOT in Vigil SKILL.md format. They use their own structure (bioSkills: code pattern cookbooks; ClawBio: README + Python scripts). Read them as expert reference material.
