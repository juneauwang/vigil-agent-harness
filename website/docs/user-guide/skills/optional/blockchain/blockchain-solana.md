...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Vigil |
| License | MIT |
...
Helper script path: ~/.vigil/skills/blockchain/solana/scripts/solana_client.py
