...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/software-development/code-wiki` |
| Path | `optional-skills/software-development/code-wiki` |
| Version | `0.1.0` |
| Author | Teknium (teknium1), Vigil |
| License | MIT |
...
Invoke through the `terminal` tool from the target repo's root, then use `read_file` / `search_files` / `write_file` to produce the wiki. Default output location is `~/.vigil/wikis/<repo-name>/`. Only write into the repo (`docs/wiki/`) when the user explicitly requests it.
...
```bash
OUTPUT_DIR="$HOME/.vigil/wikis/$REPO_NAME"
...
- [`path/to/main.py`](https://github.com/juneauwang/vigil-agent-harness) — <what runs when you start it>
- [`path/to/cli.py`](https://github.com/juneauwang/vigil-agent-harness) — <CLI surface>

## High-Level Architecture

<2-3 sentences. Detail goes in architecture.md.>

See [architecture.md](https://github.com/juneauwang/vigil-agent-harness).

## Module Map

| Module | Purpose |
|---|---|
| [`<module>`](https://github.com/juneauwang/vigil-agent-harness) | <one-line purpose> |

## Getting Started

See [getting-started.md](https://github.com/juneauwang/vigil-agent-harness).
````
...
- **<Component>** — <1-2 sentences>. See [`modules/<module>.md`](https://github.com/juneauwang/vigil-agent-harness).
...
1. **<Step>** — [`<file>`](https://github.com/juneauwang/vigil-agent-harness)
2. **<Step>** — [`<file>`](https://github.com/juneauwang/vigil-agent-harness)
...
- [`<module>/<file>`](https://github.com/juneauwang/vigil-agent-harness) — <what it does>
...
1. **User input** — [`cli.py:HermesCLI.run_session`](https://github.com/juneauwang/vigil-agent-harness)
2. **Message dispatch** — [`run_agent.py:AIAgent.chat`](https://github.com/juneauwang/vigil-agent-harness)
````
...
- Architecture: [architecture.md](https://github.com/juneauwang/vigil-agent-harness)
- Module reference: [README.md#module-map](https://github.com/juneauwang/vigil-agent-harness)
````
...
```
Generated wiki at ~/.vigil/wikis/<repo-name>/:
...
- **In-repo output without asking.** Default is `~/.vigil/wikis/`. Only write into the repo when the user explicitly requests it.
