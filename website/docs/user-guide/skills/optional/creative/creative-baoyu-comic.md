...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/creative/baoyu-comic` |
...
Adapted from [baoyu-comic](https://github.com/JimLiu/baoyu-skills) for Vigil's tool ecosystem.
...
Vigil' `image_generate` tool is **prompt-only** — it accepts a text prompt and an aspect ratio, and returns an image URL. It does **NOT** accept reference images. When the user supplies a reference image, use it to **extract traits in text** that get embedded in every page prompt:
...
Details: [references/partial-workflows.md](https://github.com/juneauwang/vigil-agent-harness)
...
- **Compatibility matrix** and **content-signal → preset** table live in [references/auto-selection.md](https://github.com/juneauwang/vigil-agent-harness). Read it before recommending combinations in Step 2.
...
Use the `clarify` tool to confirm options. Since `clarify` handles one question at a time, ask the most important question first and proceed sequentially. See [references/workflow.md](https://github.com/juneauwang/vigil-agent-harness) for the full Step 2 question set.
...
Use Vigil' built-in `image_generate` tool for all image rendering. Its schema accepts only `prompt` and `aspect_ratio` (`landscape` | `portrait` | `square`); it **returns a URL**, not a local file. Every generated page or character sheet must therefore be downloaded to the output directory.
...
Full step-by-step workflow (analysis, storyboard, review gates, regeneration variants): [references/workflow.md](https://github.com/juneauwang/vigil-agent-harness).

## References

**Core Templates**:
- [analysis-framework.md](https://github.com/juneauwang/vigil-agent-harness) - Deep content analysis
- [character-template.md](https://github.com/juneauwang/vigil-agent-harness) - Character definition format
- [storyboard-template.md](https://github.com/juneauwang/vigil-agent-harness) - Storyboard structure
- [ohmsha-guide.md](https://github.com/juneauwang/vigil-agent-harness) - Ohmsha manga specifics
...
**Workflow**:
- [workflow.md](https://github.com/juneauwang/vigil-agent-harness) - Full workflow details
- [auto-selection.md](https://github.com/juneauwang/vigil-agent-harness) - Content signal analysis
- [partial-workflows.md](https://github.com/juneauwang/vigil-agent-harness) - Partial workflow options
