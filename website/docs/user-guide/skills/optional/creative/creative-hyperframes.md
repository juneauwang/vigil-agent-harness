...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/creative/hyperframes` |
...
Full CLI reference: [references/cli.md](https://github.com/juneauwang/vigil-agent-harness).

## Setup (one-time)

```bash
bash "$(dirname "$(find ~/.vigil/skills -path '*/hyperframes/SKILL.md' 2>/dev/null | head -1)")/scripts/setup.sh"
```
...
See [references/troubleshooting.md](https://github.com/juneauwang/vigil-agent-harness) if setup fails.
...
See [references/composition.md](https://github.com/juneauwang/vigil-agent-harness) for the full data-attribute schema and composition rules.
...
See [references/gsap.md](https://github.com/juneauwang/vigil-agent-harness) for the core GSAP API (tweens, eases, stagger, timelines).
...
- [composition.md](https://github.com/juneauwang/vigil-agent-harness) — data attributes, timeline contract, non-negotiable rules, typography/asset rules
- [cli.md](https://github.com/juneauwang/vigil-agent-harness) — every CLI command (init, capture, lint, validate, inspect, preview, render, transcribe, tts, doctor, browser, info, upgrade, benchmark)
- [gsap.md](https://github.com/juneauwang/vigil-agent-harness) — GSAP core API for HyperFrames (tweens, eases, stagger, timelines, matchMedia)
- [features.md](https://github.com/juneauwang/vigil-agent-harness) — captions, TTS, audio-reactive, marker highlighting, transitions (load on demand)
- [website-to-video.md](https://github.com/juneauwang/vigil-agent-harness) — 7-step capture-to-video workflow
- [troubleshooting.md](https://github.com/juneauwang/vigil-agent-harness) — OpenClaw fix, env vars, common render errors
