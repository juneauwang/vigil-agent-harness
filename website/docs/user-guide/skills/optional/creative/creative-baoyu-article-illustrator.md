...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/creative/baoyu-article-illustrator` |
...
Adapted from [baoyu-article-illustrator](https://github.com/JimLiu/baoyu-skills) for Vigil's tool ecosystem.
...
Or use presets: `edu-visual` → type + style + palette in one shot. See [style-presets.md](https://github.com/juneauwang/vigil-agent-harness).
...
See [references/styles.md](https://github.com/juneauwang/vigil-agent-harness) for Core Styles, the full gallery, and Type × Style compatibility.
...
Full procedures: [references/workflow.md](https://github.com/juneauwang/vigil-agent-harness).
...
Full template: [references/workflow.md](https://github.com/juneauwang/vigil-agent-harness).
...
1. Create a prompt file per [references/prompt-construction.md](https://github.com/juneauwang/vigil-agent-harness).
...
Insert `![description](https://github.com/juneauwang/vigil-agent-harness)` after the corresponding paragraph. Alt text: concise description in the article's language.
...
| File | Content |
|------|---------|
| [references/workflow.md](https://github.com/juneauwang/vigil-agent-harness) | Detailed procedures |
| [references/usage.md](https://github.com/juneauwang/vigil-agent-harness) | Invocation examples |
| [references/styles.md](https://github.com/juneauwang/vigil-agent-harness) | Style gallery + Palette gallery |
| [references/style-presets.md](https://github.com/juneauwang/vigil-agent-harness) | Preset shortcuts (type + style + palette) |
| [references/prompt-construction.md](https://github.com/juneauwang/vigil-agent-harness) | Prompt templates |
