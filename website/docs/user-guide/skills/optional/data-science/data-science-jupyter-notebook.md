...
| | |
|---|---|
| Source | Optional — install with `vigil skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing vigil tool access (web_search, file ops). Stateless. |
