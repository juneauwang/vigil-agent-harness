...
| | |
|---|---|
| 来源 | 可选 — 通过 `vigil skills install official/mlops/lambda-labs` 安装 |
...
- **[高级用法](https://github.com/juneauwang/vigil-agent-harness)** — 多节点训练、API 自动化
- **[故障排查](https://github.com/juneauwang/vigil-agent-harness)** — 常见问题及解决方案
