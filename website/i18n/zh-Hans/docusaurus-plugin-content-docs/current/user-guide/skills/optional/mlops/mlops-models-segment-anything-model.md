...
| | |
|---|---|
| 来源 | 可选 — 通过 `vigil skills install official/mlops/segment-anything` 安装 |
...
# 加载模型
sam = sam_model_registry["vit_h"](https://github.com/juneauwang/vigil-agent-harness"sam_vit_h_4b8939.pth")
sam.to(device="cuda")
...
```python
# 在 VRAM 有限时使用较小模型
sam = sam_model_registry["vit_b"](https://github.com/juneauwang/vigil-agent-harness"sam_vit_b_01ec64.pth")
...
- **[高级用法](https://github.com/juneauwang/vigil-agent-harness)** - 批处理、微调、集成
- **[故障排查](https://github.com/juneauwang/vigil-agent-harness)** - 常见问题与解决方案
