...
| | |
|---|---|
| 来源 | 可选 — 通过 `vigil skills install official/mlops/peft` 安装 |
...
- **[高级用法](https://github.com/juneauwang/vigil-agent-harness)** — DoRA、LoftQ、秩稳定化、自定义模块
- **[故障排查](https://github.com/juneauwang/vigil-agent-harness)** — 常见错误、调试、优化
