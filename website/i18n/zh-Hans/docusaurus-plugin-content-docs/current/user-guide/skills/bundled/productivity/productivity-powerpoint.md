...
| 基于模板编辑或创建 | 阅读 [editing.md](https://github.com/juneauwang/vigil-agent-harness) |
| 从零创建 | 阅读 [pptxgenjs.md](https://github.com/juneauwang/vigil-agent-harness) |
...
**完整细节请阅读 [editing.md](https://github.com/juneauwang/vigil-agent-harness)。**
...
**完整细节请阅读 [pptxgenjs.md](https://github.com/juneauwang/vigil-agent-harness)。**
