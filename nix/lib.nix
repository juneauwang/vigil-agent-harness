      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via VIGIL_BUNDLED_SKILLS /
            # VIGIL_OPTIONAL_SKILLS (see hermes-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + VIGIL_BUNDLED_LOCALES
            # / VIGIL_OPTIONAL_MCPS, not via the wheel. Excluding them
