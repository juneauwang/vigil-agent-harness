...
def _is_dispatcher_owned_worker() -> bool:
    """False when VIGIL_KANBAN_* is present but this execution does not own it
    ...
    if quiet_mode:
        ...
        if profile_scope != CHECK_FN_CACHE_BYPASS:
            cache_key = (
                ...
                cfg_fp,
                bool(os.environ.get("VIGIL_KANBAN_TASK")),
...
def _compute_tool_definitions(
    ...
    if enabled_toolsets is not None:
        ...
        if (
            ...
            # Dispatcher-spawned workers are scoped by VIGIL_KANBAN_TASK and
        ...
        for toolset_name in disabled_toolsets:
            if validate_toolset(toolset_name):
                ...
                if toolset_name.startswith("hermes-") or (get_toolset(toolset_name) or {}).get("posture"):
                    # Platform bundles (hermes-*) include _VIGIL_CORE_TOOLS, and
    ...
    # window). Core Vigil tools (toolsets._VIGIL_CORE_TOOLS) are NEVER
