#!/usr/bin/env python3
"""
SWE Runner with Vigil Trajectory Format
...
- Outputs trajectories in Vigil format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Mini-SWE Runner with Vigil Trajectory Format
# ============================================================================
...
class MiniSWERunner:
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Vigil trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Vigil trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Vigil trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Vigil Trajectory Format")
    print("=" * 60)
