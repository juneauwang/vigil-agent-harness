...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("VIGIL_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("VIGIL_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("VIGIL_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
