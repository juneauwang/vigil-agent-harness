...
Real incident (gateway session 1518671026962174144)::
    ...
    cannot import name 'env_float' from 'utils' (~/.vigil/hermes-agent/utils.py)
...
2. ``vigil update`` ran ``git pull``, updating ``utils.py`` (now defining
...
``hermes_cli/main.py`` (the ``vigil update`` flow, ~line 9326) already
