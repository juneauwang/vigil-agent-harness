...
full credential environment. Two tiers:
  ...
  * Tier 2 (_VIGIL_PROVIDER_ENV_BLOCKLIST): LLM provider/tool keys — stripped
...
_TIER1_SAMPLE = {
    ...
    "VIGIL_DASHBOARD_SESSION_TOKEN": "dash-secret",
}
...
class TestDelegatedChildMarker:
    def test_delegated_child_context_scrubs_parent_kanban_keys_and_sets_marker(self):
        ...
        with patch.dict(
            ...
            {
                **_SAFE_SAMPLE,
                "VIGIL_KANBAN_TASK": "t_parent",
                "VIGIL_KANBAN_RUN_ID": "123",
                "VIGIL_KANBAN_DB": "/tmp/parent-kanban.db",
                "VIGIL_KANBAN_WORKSPACE": "/tmp/parent-workspace",
            },
            clear=True,
        ):
