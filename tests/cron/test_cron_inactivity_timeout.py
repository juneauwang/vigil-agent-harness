...
- Unlimited timeout (VIGIL_CRON_TIMEOUT=0)
- Backward compat: VIGIL_CRON_TIMEOUT env var still works
...
class TestInactivityTimeout:
    ...
    def test_unlimited_timeout(self):
        """VIGIL_CRON_TIMEOUT=0 means no timeout at all."""
        agent = FakeAgent(idle_seconds=0.0)
    ...
    def test_timeout_env_var_parsing(self, monkeypatch):
        """VIGIL_CRON_TIMEOUT env var is respected."""
        monkeypatch.setenv("VIGIL_CRON_TIMEOUT", "1200")
