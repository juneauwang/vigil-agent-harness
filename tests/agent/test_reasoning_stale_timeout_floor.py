...
thinking phase.  Vigil's default cloud-stream stale detector
(``VIGIL_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``VIGIL_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
