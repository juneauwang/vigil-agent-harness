...
manipulation. Vigil keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point VIGIL_HOME at a temp profile dir.
    ...
    VIGIL_HOME=<root>/profiles/<name> makes get_default_hermes_root()
