...
Run from the PR worktree:
    ...
    cd ~/.vigil/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.vigil/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.vigil/hermes-agent
...
# Isolated VIGIL_HOME for the config write.
