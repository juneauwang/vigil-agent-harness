...
tool registry nor a running Vigil.
"""
...
# A representative set of real toolset names. `vigil` is deliberately absent —
# that is the corruption #38798 reported (`hermes-cli` rewritten to `vigil`).
_KNOWN = {
    "hermes-cli",
    "hermes-telegram",
    "hermes-discord",
