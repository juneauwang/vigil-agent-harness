/**
 * Live skin sync from the Vigil backend.
 *
 * The backend resolves the active skin (built-in or `$VIGIL_HOME/skins/*.yaml`)
 ...
 * stomps the user's persisted desktop theme; only a genuine name change (Vigil
