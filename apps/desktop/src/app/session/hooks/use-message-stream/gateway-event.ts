 ...
 * billing-specific toast — never the generic "Vigil error" — with a smart CTA
  ...
  return useCallback(
    (event: RpcEvent) => {
      ...
      if (event.type === 'gateway.ready') {
        ...
        // A runtime skin switch (Vigil activating an authored skin, or `/skin`
        ...
        // native OS notification when Vigil is backgrounded; dispatch is gated
