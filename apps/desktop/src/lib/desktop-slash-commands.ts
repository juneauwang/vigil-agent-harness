...
/** Why a known Vigil command has no desktop UI surface. */
 ...
 * Vigil' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Vigil and were never asked for. It is
