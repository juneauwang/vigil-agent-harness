// Profile-delete routing logic for the `vigil:api` IPC handler.
//
...
/**
 * Parse a `vigil:api` request into the profile name a DELETE targets, or
...
/**
 * Route the next `vigil:api` request away from the primary/window backend
