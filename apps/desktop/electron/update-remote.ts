 ...
 *
 * A public install can end up with `origin=git@github.com:juneauwang/vigil-agent-harness.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/juneauwang/vigil-agent-harness.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/juneauwang/vigil-agent-harness'
