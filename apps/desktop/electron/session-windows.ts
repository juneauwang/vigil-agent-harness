...
// by main.ts (`setBackgroundThrottling` driven by the merged `vigil:active-work`
...
// (the "Vigil idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Vigil" wake word has NO preceding click,
