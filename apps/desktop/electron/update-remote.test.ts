 ...
 * origin=git@github.com:juneauwang/vigil-agent-harness.git. A background
...
test('canonicalGitHubRemote normalizes SSH and HTTPS forms to the same value', () => {
  assert.equal(canonicalGitHubRemote('git@github.com:juneauwang/vigil-agent-harness.git'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('git@github.com:juneauwang/vigil-agent-harness'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('ssh://git@github.com/juneauwang/vigil-agent-harness.git'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('https://github.com/juneauwang/vigil-agent-harness.git'), OFFICIAL_REPO_CANONICAL)
...
test('isSshRemote detects scp-like and ssh:// forms only', () => {
  assert.equal(isSshRemote('git@github.com:juneauwang/vigil-agent-harness.git'), true)
  assert.equal(isSshRemote('ssh://git@github.com/juneauwang/vigil-agent-harness.git'), true)
  assert.equal(isSshRemote('https://github.com/juneauwang/vigil-agent-harness'), false)
...
test('isOfficialSshRemote is true only for the official repo over SSH', () => {
  assert.equal(isOfficialSshRemote('git@github.com:juneauwang/vigil-agent-harness.git'), true)
  assert.equal(isOfficialSshRemote('git@github.com:juneauwang/vigil-agent-harness'), true)
  assert.equal(isOfficialSshRemote('ssh://git@github.com/juneauwang/vigil-agent-harness.git'), true)
...
test('isOfficialSshRemote does NOT match forks, other hosts, or HTTPS', () => {
  ...
  assert.equal(isOfficialSshRemote('git@gitlab.com:juneauwang/vigil-agent-harness.git'), false)
  ...
  assert.equal(isOfficialSshRemote('https://github.com/juneauwang/vigil-agent-harness'), false)
