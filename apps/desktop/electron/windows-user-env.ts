...
// even though a fresh shell — and the Vigil CLI — sees it immediately. The
// desktop's VIGIL_HOME resolution relies on process.env, so that stale-snapshot
...
//       VIGIL_HOME    REG_SZ    F:\Hermes\data
//
